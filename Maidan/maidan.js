/* ============================================================
   MAIDAN — the open field
   A record of the open spaces where you ran free without boundary or direction
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-maidan-fields';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'ran across ' + d.toLocaleDateString(undefined, {
