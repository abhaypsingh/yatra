/* ============================================================
   BANDHAN — the bond
   A record of the bonds that held without contract and lasted without condition
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-bandhan-bonds';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'honoured ' + d.toLocaleDateString(undefined, {
