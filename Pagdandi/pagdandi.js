/* ============================================================
   PAGDANDI — the trail
   A record of the trails you walked when there was no road
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-pagdandi-trails';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'walked ' + d.toLocaleDateString(undefined, {
