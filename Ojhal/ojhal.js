/* ============================================================
   OJHAL — the hidden one
   A record of the people and things that vanished from sight but never from memory
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-ojhal-vanished';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'lost sight of ' + d.toLocaleDateString(undefined, {
