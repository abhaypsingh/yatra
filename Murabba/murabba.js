/* ============================================================
   Murabb0101 — the preserve
   A record of the sweetness you preserved against time
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-murabba-preserves';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'preserved ' + d.toLocaleDateString(undefined, {
