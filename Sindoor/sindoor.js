/* ============================================================
   SINDOOR — the vermillion
   A record of the marks that declared belonging
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-sindoor-marks';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'applied ' + d.toLocaleDateString(undefined, {
