/* ============================================================
   Ch0101k — the potter's wheel
   A record of the spinning that shaped you into form
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-chaak-wheels';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'shaped on ' + d.toLocaleDateString(undefined, {
