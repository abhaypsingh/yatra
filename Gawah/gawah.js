/* ============================================================
   GAWAH — the witness
   A record of the moments you witnessed that were not your story but changed you anyway
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-gawah-witnesses';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'stood witness to ' + d.toLocaleDateString(undefined, {
