/* ============================================================
   CHAUNK — the tempering
   A record of the small additions that transformed everything
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-chaunk-temperings';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'sizzled ' + d.toLocaleDateString(undefined, {
