/* ============================================================
   Gobardhan — the dung-cake mountain
   A record of the humble materials you built something sacred from
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-gobardhan-mounds';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'built ' + d.toLocaleDateString(undefined, {
