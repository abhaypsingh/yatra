/* ============================================================
   DASTAKHAT — the signature
   A record of the marks you made that said this is me
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-dastakhat-signatures';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'signed ' + d.toLocaleDateString(undefined, {
