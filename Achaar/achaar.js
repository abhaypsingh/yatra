/* ============================================================
   ACHAAR — the pickle
   A record of the preservations made in the season of plenty that sustained the season of want
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-achaar-preserves';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'pickled ' + d.toLocaleDateString(undefined, {
