/* ============================================================
   GHOONGHAT — the drawn veil
   A record of the veils drawn over what was too tender to show
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-ghoonghat-veils';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'drew over ' + d.toLocaleDateString(undefined, {
