/* ============================================================
   OBHAAR — the swell
   A record of the risings that began beneath the surface before anyone could see
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-obhaar-swells';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'felt rising ' + d.toLocaleDateString(undefined, {
