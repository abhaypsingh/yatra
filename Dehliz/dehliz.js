/* ============================================================
   Dehl012Bz — the corridor
   A record of the passages between one room of life and the next
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-dehliz-corridors';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'passed through ' + d.toLocaleDateString(undefined, {
