/* ============================================================
   KATORA — the bowl
   A record of the vessels that held what was offered to you
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-katora-bowls';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'held in ' + d.toLocaleDateString(undefined, {
