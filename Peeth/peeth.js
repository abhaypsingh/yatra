/* ============================================================
   PEETH — the back
   A record of the backs turned and the strength of facing away
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-peeth-backs';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'turned from ' + d.toLocaleDateString(undefined, {
