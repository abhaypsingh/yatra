/* ============================================================
   JHILMIL — the shimmer
   A record of the shimmering moments between real and imagined
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-jhilmil-shimmers';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'glimpsed ' + d.toLocaleDateString(undefined, {
