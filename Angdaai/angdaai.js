/* ============================================================
   ANGDAAI — the stretch
   A record of the stretches that woke you to your own body
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-angdaai-stretches';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'stretched ' + d.toLocaleDateString(undefined, {
