/* ============================================================
   MOHALLA — the neighbourhood
   A record of the neighbourhoods that raised you
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-mohalla-neighbourhoods';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'belonged to ' + d.toLocaleDateString(undefined, {
