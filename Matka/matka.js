/* ============================================================
   MATKA — the earthen pot
   A record of the vessels that held and the water that cooled
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-matka-pots';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'filled ' + d.toLocaleDateString(undefined, {
