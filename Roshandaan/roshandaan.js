/* ============================================================
   ROSHANDAAN — the skylight
   A record of the openings in your ceiling that let light fall from above
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-roshandaan-skylights';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'looked up through ' + d.toLocaleDateString(undefined, {
