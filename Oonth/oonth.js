/* ============================================================
   OONTH — the camel
   A record of the long crossings made with patience and stored reserves
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-oonth-crossings';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'crossed on ' + d.toLocaleDateString(undefined, {
