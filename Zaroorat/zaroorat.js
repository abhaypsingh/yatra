/* ============================================================
   ZAROORAT — the necessity
   A record of the necessities that stripped life to its essentials
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-zaroorat-necessities';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'answered ' + d.toLocaleDateString(undefined, {
