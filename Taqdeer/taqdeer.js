/* ============================================================
   TAQDEER — the destiny
   A record of the turns that felt like destiny and the choices you made that became it
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-taqdeer-fates';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'accepted ' + d.toLocaleDateString(undefined, {
