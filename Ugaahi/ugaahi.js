/* ============================================================
   UGAAHI — the collection
   A record of the dues you collected and the debts life settled on its own terms
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-ugaahi-debts';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'collected ' + d.toLocaleDateString(undefined, {
