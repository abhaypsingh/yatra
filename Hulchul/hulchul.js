/* ============================================================
   HULCHUL — the commotion
   A record of the commotions that shook your world and what settled after the dust cleared
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-hulchul-commotions';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'survived ' + d.toLocaleDateString(undefined, {
