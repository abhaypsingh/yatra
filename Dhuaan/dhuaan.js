/* ============================================================
   DHUAAN — the smoke
   A record of the signals sent before the fire and the warnings that rose before the crisis
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-dhuaan-signals';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'saw rising ' + d.toLocaleDateString(undefined, {
