/* ============================================================
   FITRAT — the nature
   A record of the natures you discovered in yourself and others that could not be changed
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-fitrat-natures';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'recognised ' + d.toLocaleDateString(undefined, {
