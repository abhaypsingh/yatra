/* ============================================================
   Gaun0101 — the departure
   A record of the leavings that changed everything
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-gauna-departures';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'departed ' + d.toLocaleDateString(undefined, {
