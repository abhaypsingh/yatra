/* ============================================================
   CHHAAON — the shade
   A record of the sheltering presences under which you rested from the heat of the world
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-chhaaon-shades';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'rested in ' + d.toLocaleDateString(undefined, {
