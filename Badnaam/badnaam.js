/* ============================================================
   BADNAAM — the disgraced
   A record of the names tarnished and the truths that the tarnish could not hide
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-badnaam-names';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'bore ' + d.toLocaleDateString(undefined, {
