...
(function () {
  ...
  var picturesEmpty = document.getElementById('picturesEmpty');
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-chitra-pictures';
  var items = [];
  ...
  function render() {
    ...
    if (items.length === 0) {
      picturesEmpty.classList.remove('hidden');
      return;
    }

    picturesEmpty.classList.add('hidden');
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'framed ' + d.toLocaleDateString(undefined, {
