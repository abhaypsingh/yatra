/* ============================================================
   P0101ras — the philosopher's stone
   A record of the touches that turned ordinary into gold
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-paaras-stones';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'touched by ' + d.toLocaleDateString(undefined, {
