/* ============================================================
   MUTTHI — the fist
   A record of the things you held so tightly they left marks on your palm
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-mutthi-grips';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'clenched ' + d.toLocaleDateString(undefined, {
