/* ============================================================
   NAQSH — the imprint
   A record of the imprints left on you by people and places that are gone
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-naqsh-imprints';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'traced ' + d.toLocaleDateString(undefined, {
