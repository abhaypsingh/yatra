/* ============================================================
   Ma1E471E0Dap — the canopy
   A record of the sacred spaces you stood beneath at turning points
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-mandap-canopies';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'stood beneath ' + d.toLocaleDateString(undefined, {
