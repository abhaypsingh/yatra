/* ============================================================
   SAUDAA — the bargain
   A record of the bargains struck between what you wanted and what you got
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-saudaa-bargains';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'struck ' + d.toLocaleDateString(undefined, {
