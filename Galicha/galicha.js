/* ============================================================
   GALICHA — the carpet
   A record of the carpets that softened the ground beneath you
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-galicha-carpets';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'unrolled ' + d.toLocaleDateString(undefined, {
