/* ============================================================
   Kha1E6Dal — the cattle shed
   A record of the creatures and responsibilities you tended
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-khatal-sheds';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'tended ' + d.toLocaleDateString(undefined, {
