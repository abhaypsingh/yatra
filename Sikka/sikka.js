/* ============================================================
   SIKKA — the coin
   A record of the currencies exchanged between people beyond money
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-sikka-coins';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'exchanged ' + d.toLocaleDateString(undefined, {
