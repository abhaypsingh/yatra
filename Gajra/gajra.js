/* ============================================================
   GAJRA — the flower garland
   A record of the garlands that adorned and the fragrance they carried
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-gajra-garlands';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'woven ' + d.toLocaleDateString(undefined, {
