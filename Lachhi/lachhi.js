/* ============================================================
   LACHHI — the buttermilk
   A record of the simple refreshments that restored you after the churning
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-lachhi-sips';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'sipped ' + d.toLocaleDateString(undefined, {
