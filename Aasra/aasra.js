/* ============================================================
   AASRA — the refuge
   A record of the refuges found when every other door was closed
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-aasra-refuges';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'found ' + d.toLocaleDateString(undefined, {
