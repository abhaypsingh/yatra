/* ============================================================
   YAKEEN — the belief
   A record of the beliefs that held you when evidence alone could not
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-yakeen-beliefs';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'held onto ' + d.toLocaleDateString(undefined, {
