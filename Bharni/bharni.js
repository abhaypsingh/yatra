/* ============================================================
   BHARNI — the filling
   A record of the acts of filling that made empty vessels whole
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-bharni-fillings';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'filled with ' + d.toLocaleDateString(undefined, {
