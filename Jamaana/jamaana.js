/* ============================================================
   JAMAANA — the age
   A record of the worlds you lived in that no longer exist except in memory
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-jamaana-ages';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'lived in ' + d.toLocaleDateString(undefined, {
