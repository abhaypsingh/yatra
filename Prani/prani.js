/* ============================================================
   PRANI — the creature
   A record of the animals who have been part of your story
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-prani-creatures';
  var items = [];
  ...
  function saveItem() {
    ...
    if (!name) return;
    var bond = writeInput.value.trim();
    items.push({ name: name, bond: bond, timestamp: Date.now() });
    save();
    closeWrite();
    render();
  }
