/* ============================================================
   PEHEL — the initiative
   A record of the initiatives that protect and trap you
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-pehel-firsts';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'stepped ' + d.toLocaleDateString(undefined, {
