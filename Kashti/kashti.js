/* ============================================================
   KASHTI — the boat
   A record of the vessels that carried you across waters you could not have swum alone
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-kashti-boats';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'sailed in ' + d.toLocaleDateString(undefined, {
