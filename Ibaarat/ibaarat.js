/* ============================================================
   IBAARAT — the expression
   A record of the expressions that captured truth
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-ibaarat-expressions';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'wrote ' + d.toLocaleDateString(undefined, {
