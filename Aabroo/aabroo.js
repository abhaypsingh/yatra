/* ============================================================
   AABROO — the honour
   A record of the moments when your dignity was tested and what you chose to protect
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-aabroo-dignities';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'defended ' + d.toLocaleDateString(undefined, {
