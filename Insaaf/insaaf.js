/* ============================================================
   INSAAF — the justice
   A record of the justices sought and the ones that arrived in unexpected forms
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-insaaf-verdicts';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'sought ' + d.toLocaleDateString(undefined, {
