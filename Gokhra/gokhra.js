/* ============================================================
   Gokhr0101 — the ventilation grate
   A record of the small openings that let you breathe
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-gokhra-grates';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'breathed through ' + d.toLocaleDateString(undefined, {
