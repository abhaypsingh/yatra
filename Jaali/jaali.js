/* ============================================================
   JAALI — the lattice
   A record of the lattices that let you see without being seen
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-jaali-lattices';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'peered through ' + d.toLocaleDateString(undefined, {
