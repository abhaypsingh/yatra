/* ============================================================
   ILTIJA — the supplication
   A record of the prayers whispered in desperation
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-iltija-supplications';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'whispered ' + d.toLocaleDateString(undefined, {
