/* ============================================================
   KHOMCHA — the street vendor2019s cart
   A record of the small carts that brought you exactly what you craved
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-khomcha-carts';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'bought from ' + d.toLocaleDateString(undefined, {
