/* ============================================================
   CHAAKRI — the service
   A record of the duties you performed day after day that no one noticed or thanked you for
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-chaakri-duties';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'performed ' + d.toLocaleDateString(undefined, {
