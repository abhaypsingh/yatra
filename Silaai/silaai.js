/* ============================================================
   Sil0101012B — the stitching
   A record of the things you mended with needle and patience
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-silaai-stitches';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'mended ' + d.toLocaleDateString(undefined, {
