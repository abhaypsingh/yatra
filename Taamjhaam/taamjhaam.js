/* ============================================================
   T0101mjh0101m — the grand display
   A record of the spectacles that dazzled and what lay behind them
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-taamjhaam-displays';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'witnessed ' + d.toLocaleDateString(undefined, {
