/* ============================================================
   BICHHUA — the scorpion
   A record of the stings that came without warning
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-bichhua-stings';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'stung by ' + d.toLocaleDateString(undefined, {
