/* ============================================================
   FAREB — the deception
   A record of the deceptions that taught you vigilance
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-fareb-deceptions';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'uncovered ' + d.toLocaleDateString(undefined, {
