/* ============================================================
   IJAAZAT — the permission
   A record of the permissions granted that set something free in you
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-ijaazat-permissions';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'was granted ' + d.toLocaleDateString(undefined, {
