/* ============================================================
   Kathal — the jackfruit
   A record of the things that were difficult to open but rich inside
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-kathal-harvests';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'opened ' + d.toLocaleDateString(undefined, {
