/* ============================================================
   SALAAKH — the iron bar
   A record of the bars that stood between you and what you wanted
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-salaakh-bars';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'gripped ' + d.toLocaleDateString(undefined, {
