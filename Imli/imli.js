/* ============================================================
   IMLI — the tamarind
   A record of the sour truths that made the sweet ones sweeter
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-imli-tastes';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'tasted ' + d.toLocaleDateString(undefined, {
