/* ============================================================
   AARSI — the mirror ring
   A record of the tiny mirrors in which you glimpsed yourself unexpectedly
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-aarsi-mirrors';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'glimpsed in ' + d.toLocaleDateString(undefined, {
