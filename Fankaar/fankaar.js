/* ============================================================
   FANKAAR — the artist
   A record of the artists whose work rearranged something inside you
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-fankaar-artists';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'was moved by ' + d.toLocaleDateString(undefined, {
