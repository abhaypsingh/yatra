/* ============================================================
   Bair0101g012B — the renunciant
   A record of the things you chose to walk away from
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-bairagi-renunciations';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'released ' + d.toLocaleDateString(undefined, {
