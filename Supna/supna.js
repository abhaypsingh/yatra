/* ============================================================
   SUPNA — the dream
   A record of the dreams that visited and the ones that stayed
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-supna-dreams';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'dreamed ' + d.toLocaleDateString(undefined, {
