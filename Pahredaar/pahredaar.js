/* ============================================================
   PAHREDAAR — the watchman
   A record of the guardians who watched over you while you slept
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-pahredaar-guards';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'was watched by ' + d.toLocaleDateString(undefined, {
