/* ============================================================
   CHOWK — the crossroads
   A record of where your paths cross
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-chowk-crossroads';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'stood at ' + d.toLocaleDateString(undefined, {
