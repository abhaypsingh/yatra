/* ============================================================
   Bai1E6Dhak — the sitting room
   A record of the rooms where guests were received and truths were shared
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-baithak-sittings';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'received in ' + d.toLocaleDateString(undefined, {
