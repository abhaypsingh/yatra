/* ============================================================
   SEEDHI — the staircase
   A record of the things you are learning step by step
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-seedhi-steps';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'climbed ' + d.toLocaleDateString(undefined, {
