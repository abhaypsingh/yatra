/* ============================================================
   Sip0101h012B — the soldier
   A record of the posts where you stood guard without recognition
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-sipahi-soldiers';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'stood guard ' + d.toLocaleDateString(undefined, {
