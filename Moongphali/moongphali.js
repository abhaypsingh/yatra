/* ============================================================
   M016Bngphal012B — the peanut
   A record of the simple pleasures shared in company
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-moongphali-peanuts';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'shared ' + d.toLocaleDateString(undefined, {
