/* ============================================================
   RONAK — the radiance
   A record of the radiances that lit up rooms and seasons of your life
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-ronak-lights';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'basked in ' + d.toLocaleDateString(undefined, {
