/* ============================================================
   CHAUKONI — the square
   A record of the four-cornered boundaries that gave your life its shape
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-chaukoni-squares';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'drew around ' + d.toLocaleDateString(undefined, {
