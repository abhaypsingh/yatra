  ...
  var SECTIONS = [
    ...
    },
    {
      ...
      items: [
        ...
        ['Aarsi', '\u0100rs\u012B', 'the mirror ring'],
        ['Bakhar', 'Bakhar', 'the granary'],
        ['Chaukoni', 'Chaukon\u012B', 'the square'],
        ['Daastan', 'D\u0101st\u0101n', 'the epic tale'],
        ['Eent', '\u0100\u1E47\u1E6D', 'the brick'],
        ['Fasal', 'Fasal', 'the harvest'],
        ['Gufaa', 'Guf\u0101', 'the cave'],
        ['Haathkadhi', 'Haathkadh\u012B', 'the shackle'],
        ['Imli', 'Iml\u012B', 'the tamarind'],
        ['Jhoola', 'Jh\u016Bl\u0101', 'the swing'],
        ['Kachnar', 'Kachnar', 'the orchid tree'],
        ['Lachhi', 'Lachh\u012B', 'the buttermilk'],
        ['Machli', 'Machhl\u012B', 'the fish'],
        ['Nagma', 'Nagm\u0101', 'the melody'],
        ['Ojhal', 'Ojhal', 'the hidden one'],
        ['Palang', 'Palang', 'the cot'],
        ['Qissa', 'Qiss\u0101', 'the story'],
        ['Roshandaan', 'Roshand\u0101n', 'the skylight'],
        ['Saugaat', 'Saug\u0101t', 'the gift'],
        ['Taksal', 'Taksal', 'the mint'],
        ['Ugaahi', 'Ug\u0101h\u012B', 'the collection'],
        ['Vaaris', 'V\u0101ris', 'the heir'],
        ['Yakeen', 'Yaq\u012Bn', 'the belief'],
        ['Zanjeeri', 'Zanjeir\u012B', 'the chain'],
        ['Aamad', '\u0100mad', 'the arrival'],
        ['Basera', 'Baser\u0101', 'the roost'],
        ['Chabeel', 'Chab\u012Bl', 'the sweet water stand'],
        ['Daur', 'Daur', 'the era'],
        ['Fankaar', 'Fank\u0101r', 'the artist'],
        ['Girvi', 'Girv\u012B', 'the pawn'],
        ['Hunnar', 'Hunnar', 'the craft'],
        ['Ijaazat', 'Ij\u0101zat', 'the permission'],
        ['Jhingur', 'Jhingur', 'the cricket'],
        ['Kaarigari', 'K\u0101r\u012Bgar\u012B', 'the craftsmanship'],
        ['Laadli', 'L\u0101dl\u012B', 'the cherished one'],
        ['Maidan', 'Maid\u0101n', 'the open field'],
        ['Naukar', 'Naukar', 'the servant'],
        ['Oonth', '\u016A\u1E47\u1E6Dh', 'the camel'],
        ['Pahredaar', 'Pahred\u0101r', 'the watchman'],
        ['Reet', 'R\u012Bt', 'the custom'],
        ['Saudaa', 'Saud\u0101', 'the bargain'],
        ['Taash', 'T\u0101sh', 'the playing cards'],
        ['Vaidya', 'Vaidya', 'the healer'],
        ['Zaamin', 'Z\u0101min', 'the guarantor'],
        ['Aabroo', '\u0100br\u016B', 'the honour'],
        ['Baoli', 'B\u0101ol\u012B', 'the stepwell'],
        ['Chaakri', 'Ch\u0101kr\u012B', 'the service'],
        ['Dabba', 'Dabb\u0101', 'the lunchbox'],
        ['Ghaat', 'Gh\u0101\u1E6D', 'the river steps'],
        ['Hulchul', 'Hulchul', 'the commotion'],
        ['Ahsaan', 'Ahs\u0101n', 'the favour'],
        ['Baarish', 'B\u0101rish', 'the rain'],
        ['Taala', 'T\u0101l\u0101', 'the lock'],
        ['Darwaza', 'Darw\u0101z\u0101', 'the door'],
        ['Ronak', 'Ronak', 'the radiance'],
        ['Fitrat', 'Fitrat', 'the nature'],
        ['Gulaab', 'Gul\u0101b', 'the rose'],
        ['Hisaab', 'His\u0101b', 'the account'],
        ['Insaaf', 'Ins\u0101f', 'the justice'],
        ['Jamaana', 'Jam\u0101n\u0101', 'the age'],
        ['Kasak', 'Kasak', 'the lingering ache'],
        ['Sikka', 'Sikk\u0101', 'the coin'],
        ['Morchha', 'Morchh\u0101', 'the barricade'],
        ['Naara', 'N\u0101r\u0101', 'the war cry'],
        ['Odhni', 'Odhn\u012B', 'the shawl'],
        ['Salaakh', 'Sal\u0101kh', 'the iron bar'],
        ['Qarz', 'Qarz', 'the debt'],
        ['Rukhsat', 'Rukhsat', 'the farewell'],
        ['Saaya', 'S\u0101y\u0101', 'the shadow'],
        ['Taqdeer', 'Taqd\u012Br', 'the destiny'],
        ['Bisat', 'Bis\u0101t', 'the chessboard'],
        ['Vasiyat', 'Vas\u012Byat', 'the will'],
        ['Wafaa', 'Waf\u0101', 'the loyalty'],
        ['Zubaan', 'Zub\u0101n', 'the tongue'],
        ['Achaar', 'Ach\u0101r', 'the pickle'],
        ['Badnaam', 'Badn\u0101m', 'the disgraced'],
        ['Chashma', 'Chashm\u0101', 'the spring'],
        ['Dhuaan', 'Dhu\u0101\u0303', 'the smoke'],
        ['Fariyaad', 'Fariy\u0101d', 'the plea'],
        ['Gawah', 'Gaw\u0101h', 'the witness'],
        ['Hissa', 'Hiss\u0101', 'the share'],
        ['Izzat', 'Izzat', 'the respect'],
        ['Jawaab', 'Jaw\u0101b', 'the answer'],
        ['Kashti', 'Kasht\u012B', 'the boat'],
        ['Lehja', 'Lehj\u0101', 'the accent'],
        ['Mohar', 'Mohar', 'the seal'],
        ['Naqsh', 'Naqsh', 'the imprint'],
        ['Obhaar', 'Ubh\u0101r', 'the swell'],
        ['Mutthi', 'Mu\u1E6D\u1E6Dh\u012B', 'the fist'],
        ['Qaid', 'Qaid', 'the imprisonment'],
        ['Khaamooshi', 'Kh\u0101mosh\u012B', 'the silence'],
        ['Sabaq', 'Sabaq', 'the lesson'],
        ['Guftagu', 'Guftag\u016B', 'the conversation'],
        ['Ujala', 'Uj\u0101l\u0101', 'the brightness'],
        ['Paheli', 'Pahel\u012B', 'the riddle'],
        ['Watan', 'Watan', 'the homeland'],
