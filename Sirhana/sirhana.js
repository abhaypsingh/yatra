/* ============================================================
   SIRHANA — the headrest
   A record of the places you rested your head and what you dreamed
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-sirhana-headrests';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'rested on ' + d.toLocaleDateString(undefined, {
