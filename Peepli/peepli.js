/* ============================================================
   P012Bpl012B — the sacred fig leaf
   A record of the sacred rustling that spoke without words
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-peepli-leaves';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'rustled ' + d.toLocaleDateString(undefined, {
