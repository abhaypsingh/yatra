/* ============================================================
   MUSĀFIR — the traveller
   The journeys you are always on
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-musafir-travellers';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'journeyed ' + d.toLocaleDateString(undefined, {
