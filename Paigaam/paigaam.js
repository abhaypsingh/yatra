/* ============================================================
   PAIGAAM — the message
   A record of the messages that arrived at the right moment
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-paigaam-messages';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'delivered ' + d.toLocaleDateString(undefined, {
