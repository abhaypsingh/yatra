/* ============================================================
   FASAL — the harvest
   A record of the harvests reaped from seeds you planted long ago
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-fasal-harvests';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'reaped ' + d.toLocaleDateString(undefined, {
