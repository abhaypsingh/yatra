/* ============================================================
   Gilaur012B — the betel fold
   A record of the small offerings that sealed a moment
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-gilauri-folds';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'offered ' + d.toLocaleDateString(undefined, {
