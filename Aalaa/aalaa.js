/* ============================================================
   AALAA — the shelf niche
   A record of the small niches where precious things were kept
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-aalaa-niches';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'placed on ' + d.toLocaleDateString(undefined, {
