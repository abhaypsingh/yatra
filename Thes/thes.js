/* ============================================================
   THES — the stumble
   A record of the stumbles that taught you to watch your step
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-thes-stumbles';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'stumbled ' + d.toLocaleDateString(undefined, {
