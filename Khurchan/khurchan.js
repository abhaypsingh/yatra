/* ============================================================
   Khurchan — the scraping
   A record of what you scraped from the bottom of the vessel
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-khurchan-scrapings';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'scraped ' + d.toLocaleDateString(undefined, {
