/* ============================================================
   Paga1E5Bh — the turban
   A record of the dignities you wound around yourself
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-pagarh-turbans';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'wound ' + d.toLocaleDateString(undefined, {
