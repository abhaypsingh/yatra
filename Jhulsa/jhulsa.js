/* ============================================================
   Jhuls0101 — the scorch
   A record of the heat that transformed you
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-jhulsa-scorches';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'burned by ' + d.toLocaleDateString(undefined, {
