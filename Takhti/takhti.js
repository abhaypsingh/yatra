/* ============================================================
   Takht012B — the writing slate
   A record of the lessons written and erased
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-takhti-slates';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'wrote on ' + d.toLocaleDateString(undefined, {
