/* ============================================================
   GUFAA — the cave
   A record of the caves where you retreated to find what could only be found in darkness
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-gufaa-caves';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'entered ' + d.toLocaleDateString(undefined, {
