/* ============================================================
   Phulk0101r012B — the flower work
   A record of the beauty stitched into the ordinary
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-phulkari-embroideries';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'stitched ' + d.toLocaleDateString(undefined, {
