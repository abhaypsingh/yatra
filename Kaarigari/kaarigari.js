/* ============================================================
   KAARIGARI — the craftsmanship
   A record of the works of careful craft that taught you what patience makes possible
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-kaarigari-works';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'marvelled at ' + d.toLocaleDateString(undefined, {
