/* ============================================================
   HISSA — the share
   A record of the portions claimed and relinquished in the division of life
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-hissa-shares';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'claimed ' + d.toLocaleDateString(undefined, {
