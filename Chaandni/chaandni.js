/* ============================================================
   CHAANDNI — the moonlight
   A record of the moonlit moments that revealed what daylight hid
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-chaandni-moons';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'bathed in ' + d.toLocaleDateString(undefined, {
