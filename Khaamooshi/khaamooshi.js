/* ============================================================
   KHAAMOOSHI — the silence
   A record of the silences that said more than any words could have
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-khaamooshi-silences';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'sat in ' + d.toLocaleDateString(undefined, {
