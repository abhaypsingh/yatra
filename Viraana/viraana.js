/* ============================================================
   VIRAANA — the desolation
   A record of the ruins you walked through
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-viraana-ruins';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'walked through ' + d.toLocaleDateString(undefined, {
