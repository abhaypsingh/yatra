/* ============================================================
   JHAROKHA — the balcony
   A record of the thresholds you linger on
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-jharokha-thresholds';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'lingered ' + d.toLocaleDateString(undefined, {
