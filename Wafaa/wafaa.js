/* ============================================================
   WAFAA — the loyalty
   A record of the loyalties kept through seasons when it would have been easier to leave
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-wafaa-loyalties';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'kept ' + d.toLocaleDateString(undefined, {
