/* ============================================================
   Ghungha1E6D — the veil
   A record of what you hid and what you revealed
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-ghunghat-veils';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'lifted ' + d.toLocaleDateString(undefined, {
