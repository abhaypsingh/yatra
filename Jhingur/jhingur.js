/* ============================================================
   JHINGUR — the cricket
   A record of the small persistent songs that filled the silence of your nights
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-jhingur-songs';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'listened to ' + d.toLocaleDateString(undefined, {
