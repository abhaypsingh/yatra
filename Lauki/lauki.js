/* ============================================================
   LAUKI — the gourd
   A record of the bland nourishments that healed without being asked
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-lauki-gourds';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'cooked with ' + d.toLocaleDateString(undefined, {
