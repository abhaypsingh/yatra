/* ============================================================
   MORCHHA — the barricade
   A record of the positions held when retreat would have been easier
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-morchha-positions';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'held ' + d.toLocaleDateString(undefined, {
