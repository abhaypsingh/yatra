/* ============================================================
   GOTHRI — the bundle
   A record of the bundles you tied and carried from one chapter to the next
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-gothri-bundles';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'tied into ' + d.toLocaleDateString(undefined, {
