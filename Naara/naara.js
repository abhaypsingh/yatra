/* ============================================================
   NAARA — the war cry
   A record of the cries that rallied you when courage was running out
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-naara-cries';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'shouted ' + d.toLocaleDateString(undefined, {
