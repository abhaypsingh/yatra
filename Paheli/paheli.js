/* ============================================================
   PAHELI — the riddle
   A record of the puzzles that life posed and the answers that came only with living
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-paheli-riddles';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'puzzled over ' + d.toLocaleDateString(undefined, {
