/* ============================================================
   GUFTAGU — the conversation
   A record of the conversations that changed you from the inside without you noticing until later
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-guftagu-talks';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'had ' + d.toLocaleDateString(undefined, {
