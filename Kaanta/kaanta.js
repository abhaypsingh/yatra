/* ============================================================
   KAANTA — the thorn
   A record of the thorns that pricked and the roses they guarded
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-kaanta-thorns';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'pricked by ' + d.toLocaleDateString(undefined, {
