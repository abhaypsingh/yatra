/* ============================================================
   JUGAAD — the improvisation
   A record of the improvisations that protect and trap you
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-jugaad-fixes';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'fixed ' + d.toLocaleDateString(undefined, {
