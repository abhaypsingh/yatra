/* ============================================================
   Mach0101n — the watchtower platform
   A record of the elevated perches where you watched life move below
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-machaan-platforms';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'watched from ' + d.toLocaleDateString(undefined, {
