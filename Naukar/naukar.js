/* ============================================================
   NAUKAR — the servant
   A record of the acts of service that asked for nothing in return
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-naukar-services';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'served ' + d.toLocaleDateString(undefined, {
