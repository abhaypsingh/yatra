/* ============================================================
   NISHAANI — the token
   A record of the tokens that proved what words could not
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-nishaani-tokens';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'treasured ' + d.toLocaleDateString(undefined, {
