/* ============================================================
   SAHELI — the confidante
   A record of who holds your truths
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-saheli-confidantes';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'shared with ' + d.toLocaleDateString(undefined, {
