/* ============================================================
   0100nchal — the embrace
   A record of the sheltering folds you found
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-aanchal-embraces';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'sheltered in ' + d.toLocaleDateString(undefined, {
