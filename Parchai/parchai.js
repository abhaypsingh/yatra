/* ============================================================
   PARCHAI — the shadow-self
   A record of the shadows that followed you everywhere
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-parchai-shadows';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'followed ' + d.toLocaleDateString(undefined, {
