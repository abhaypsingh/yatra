/* ============================================================
   CHAADAR — the bedsheet
   A record of the sheets that covered and the comfort they gave
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-chaadar-sheets';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'spread ' + d.toLocaleDateString(undefined, {
