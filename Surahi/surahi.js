/* ============================================================
   SURAHI — the clay pitcher
   A record of the vessels that kept things cool and pure
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-surahi-pitchers';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'poured ' + d.toLocaleDateString(undefined, {
