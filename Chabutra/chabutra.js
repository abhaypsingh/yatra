/* ============================================================
   Chabutr0101 — the platform
   A record of the raised platforms where life was shared
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-chabutra-platforms';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'sat on ' + d.toLocaleDateString(undefined, {
