/* ============================================================
   EENT — the brick
   A record of the single bricks that built the structures of your life
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-eent-bricks';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'laid ' + d.toLocaleDateString(undefined, {
