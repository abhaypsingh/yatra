/* ============================================================
   JHAALAR — the fringe of light
   A record of the decorative fringes that lit the edges of your celebrations
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-jhaalar-fringes';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'strung up ' + d.toLocaleDateString(undefined, {
