/* ============================================================
   ANGITHI — the brazier
   A record of the small fires people gathered around
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-angithi-braziers';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'gathered at ' + d.toLocaleDateString(undefined, {
