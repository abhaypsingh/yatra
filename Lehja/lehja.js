/* ============================================================
   LEHJA — the accent
   A record of the accents and tones that revealed where someone truly came from
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-lehja-accents';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'heard in ' + d.toLocaleDateString(undefined, {
