/* ============================================================
   ZUBAAN — the tongue
   A record of the words spoken that could not be unspoken and the silences that said more
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-zubaan-words';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'spoke ' + d.toLocaleDateString(undefined, {
