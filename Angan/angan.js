/* ============================================================
   0100ngan — the courtyard
   A record of the open centres where your family gathered
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-angan-courtyards';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'gathered in ' + d.toLocaleDateString(undefined, {
