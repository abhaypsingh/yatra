/* ============================================================
   Bajr0101 — the millet
   A record of the humble grains that sustained you through drought
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-bajra-grains';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'harvested ' + d.toLocaleDateString(undefined, {
