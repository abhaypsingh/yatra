/* ============================================================
   CHAMELI — the jasmine
   A record of the fragrances that arrived uninvited and changed the air
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-chameli-blooms';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'breathed in ' + d.toLocaleDateString(undefined, {
