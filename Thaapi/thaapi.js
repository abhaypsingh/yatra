/* ============================================================
   Th0101p012B — the hand-stamp
   A record of the marks you pressed into wet clay and memory
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-thaapi-stamps';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'pressed ' + d.toLocaleDateString(undefined, {
