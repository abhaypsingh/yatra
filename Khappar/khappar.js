/* ============================================================
   Khappar — the begging bowl
   A record of the times you emptied yourself to receive
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-khappar-bowls';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'emptied ' + d.toLocaleDateString(undefined, {
