/* ============================================================
   Chhajj0101 — the overhang
   A record of the shelters that jutted out just enough
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-chhajja-overhangs';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'sheltered under ' + d.toLocaleDateString(undefined, {
