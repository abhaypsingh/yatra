/* ============================================================
   ...
   A record of the ovens that transformed raw dough into nourishment
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-tandoor-ovens';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'fired ' + d.toLocaleDateString(undefined, {
