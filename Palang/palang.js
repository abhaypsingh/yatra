/* ============================================================
   PALANG — the cot
   A record of the beds where you lay awake thinking the thoughts that shaped your life
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-palang-cots';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'lay on ' + d.toLocaleDateString(undefined, {
