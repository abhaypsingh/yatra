/* ============================================================
   ZAAMIN — the guarantor
   A record of those who stood surety for you when you had nothing to offer but your word
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-zaamin-guarantors';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'was vouched for by ' + d.toLocaleDateString(undefined, {
