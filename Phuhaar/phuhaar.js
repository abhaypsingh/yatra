/* ============================================================
   Phuh0101r — the drizzle
   A record of the gentle rains that soaked you slowly
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-phuhaar-drizzles';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'walked in ' + d.toLocaleDateString(undefined, {
