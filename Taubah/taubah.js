/* ============================================================
   TAUBAH — the repentance
   A record of the repentances that turned you around
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-taubah-repentances';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'made ' + d.toLocaleDateString(undefined, {
