/* ============================================================
   TAKSAL — the mint
   A record of the places where your values were stamped and given currency
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-taksal-mints';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'minted in ' + d.toLocaleDateString(undefined, {
