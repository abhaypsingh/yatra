/* ============================================================
   KANGAN — the bangle
   A record of the bangles that adorned and the circles that bound
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-kangan-bangles';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'worn ' + d.toLocaleDateString(undefined, {
