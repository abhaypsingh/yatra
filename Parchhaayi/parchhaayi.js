/* ============================================================
   PARCHHAAYI — the reflection in others
   A record of what you see in others that mirrors yourself
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-parchhaayi-reflections';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'seen ' + d.toLocaleDateString(undefined, {
