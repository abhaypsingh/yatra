/* ============================================================
   IZZAT — the respect
   A record of the respects earned and the ones demanded that were never deserved
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-izzat-respects';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'earned ' + d.toLocaleDateString(undefined, {
