/* ============================================================
   TAASH — the playing cards
   A record of the hands you were dealt and how you chose to play them
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-taash-hands';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'played ' + d.toLocaleDateString(undefined, {
