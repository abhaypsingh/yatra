/* ============================================================
   THAKAN — the tiredness
   A record of the tirednesss that protect and trap you
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-thakan-rests';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'rested ' + d.toLocaleDateString(undefined, {
