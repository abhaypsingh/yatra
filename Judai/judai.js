/* ============================================================
   JUDAI — the separation
   A record of the separations that carved emptiness
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-judai-separations';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'weathered ' + d.toLocaleDateString(undefined, {
