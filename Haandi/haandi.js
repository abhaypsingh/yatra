/* ============================================================
   HAANDI — the cooking pot
   A record of the slow simmering that made you who you are
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-haandi-pots';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'simmered ' + d.toLocaleDateString(undefined, {
