/* ============================================================
   RUKHSAT — the farewell
   A record of the farewells that marked the end of one chapter and the unnamed beginning of another
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-rukhsat-farewells';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'said ' + d.toLocaleDateString(undefined, {
