/* ============================================================
   SAUDAAGAR — the merchant
   A record of the trades that shaped your fortune
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-saudaagar-trades';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'brokered ' + d.toLocaleDateString(undefined, {
