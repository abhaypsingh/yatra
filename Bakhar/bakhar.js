/* ============================================================
   BAKHAR — the granary
   A record of the storehouses where you kept what would sustain you through lean seasons
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-bakhar-stores';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'stored in ' + d.toLocaleDateString(undefined, {
