/* ============================================================
   QAID — the imprisonment
   A record of the imprisonments real and imagined that held you and what you did with the time inside
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-qaid-cells';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'endured ' + d.toLocaleDateString(undefined, {
