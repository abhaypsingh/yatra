/* ============================================================
   BEGAANI — the estrangement
   A record of the distances that grew between you and others
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-begaani-distances';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'sensed ' + d.toLocaleDateString(undefined, {
