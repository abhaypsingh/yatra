/* ============================================================
   NAGMA — the melody
   A record of the melodies that stayed in your head long after the song ended
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-nagma-melodies';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'hummed ' + d.toLocaleDateString(undefined, {
