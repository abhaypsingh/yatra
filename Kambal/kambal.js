/* ============================================================
   KAMBAL — the blanket
   A record of the blankets that shielded you from the cold
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-kambal-blankets';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'wrapped in ' + d.toLocaleDateString(undefined, {
