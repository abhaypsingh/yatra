/* ============================================================
   WATAN — the homeland
   A record of the places you called home and the ache of the ones you left behind
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-watan-homes';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'longed for ' + d.toLocaleDateString(undefined, {
