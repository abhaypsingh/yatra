/* ============================================================
   HISAAB — the account
   A record of the accounts kept between people who love each other
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-hisaab-accounts';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'settled ' + d.toLocaleDateString(undefined, {
