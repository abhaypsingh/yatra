/* ============================================================
   LAADLI — the cherished one
   A record of the people who were cherished beyond reason and loved beyond measure
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-laadli-cherished';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'cherished ' + d.toLocaleDateString(undefined, {
