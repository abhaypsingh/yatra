/* ============================================================
   ZEHER — the poison
   A record of the bitternesses swallowed that slowly became immunity
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-zeher-doses';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'swallowed ' + d.toLocaleDateString(undefined, {
