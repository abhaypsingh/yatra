/* ============================================================
   BISAT — the chessboard
   A record of the boards on which you played games whose rules you did not fully understand
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-bisat-boards';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'played on ' + d.toLocaleDateString(undefined, {
