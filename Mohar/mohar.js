/* ============================================================
   MOHAR — the seal
   A record of the seals stamped on decisions that could not be undone
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-mohar-seals';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'stamped ' + d.toLocaleDateString(undefined, {
