/* ============================================================
   GIRVI — the pawn
   A record of the things you pledged against a future you hoped would come
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-girvi-pledges';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'pawned ' + d.toLocaleDateString(undefined, {
