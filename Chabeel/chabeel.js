/* ============================================================
   CHABEEL — the sweet water stand
   A record of the free offerings given to strangers in the heat
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-chabeel-stands';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'drank from ' + d.toLocaleDateString(undefined, {
