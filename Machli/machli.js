/* ============================================================
   MACHLI — the fish
   A record of the silent swimmers who moved through the currents of your life
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-machli-fish';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'watched swim ' + d.toLocaleDateString(undefined, {
