/* ============================================================
   BASERA — the roost
   A record of the places where you came to rest at the end of the day
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-basera-roosts';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'roosted in ' + d.toLocaleDateString(undefined, {
