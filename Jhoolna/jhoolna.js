/* ============================================================
   JHOOLNA — the swing
   A record of the swings that lifted you between earth and sky
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-jhoolna-swings';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'swung on ' + d.toLocaleDateString(undefined, {
