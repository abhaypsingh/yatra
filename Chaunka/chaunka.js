/* ============================================================
   Chaunk0101 — the kitchen hearth
   A record of the fires around which your family fed itself
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-chaunka-hearths';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'cooked at ' + d.toLocaleDateString(undefined, {
