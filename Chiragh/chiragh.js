/* ============================================================
   Chir0101gh — the oil lamp
   A record of the lights you lit against the darkness
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-chiragh-lamps';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'lit ' + d.toLocaleDateString(undefined, {
