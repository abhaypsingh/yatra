/* ============================================================
   HUNNAR — the craft
   A record of the skills your hands learned that your mind cannot forget
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-hunnar-crafts';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'mastered ' + d.toLocaleDateString(undefined, {
