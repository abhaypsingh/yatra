/* ============================================================
   DAASTAN — the epic tale
   A record of the stories told to you that became part of your own story
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-daastan-tales';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'heard ' + d.toLocaleDateString(undefined, {
