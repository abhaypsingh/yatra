/* ============================================================
   Khirk012B — the window
   A record of the frames through which you saw the world
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-khirki-windows';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'looked through ' + d.toLocaleDateString(undefined, {
