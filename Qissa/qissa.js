/* ============================================================
   QISSA — the story
   A record of the stories others told about you that became truer than truth
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-qissa-stories';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'was told ' + d.toLocaleDateString(undefined, {
