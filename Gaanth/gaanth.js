/* ============================================================
   GAANTH — the knot
   A record of the knots that bound and the ones that would not untie
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-gaanth-knots';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'tied ' + d.toLocaleDateString(undefined, {
