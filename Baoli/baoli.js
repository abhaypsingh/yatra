/* ============================================================
   BAOLI — the stepwell
   A record of the descents you made to reach the water hidden beneath the surface
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-baoli-descents';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'descended into ' + d.toLocaleDateString(undefined, {
