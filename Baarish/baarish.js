/* ============================================================
   BAARISH — the rain
   A record of the rains that arrived when the earth had cracked from waiting
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-baarish-rains';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'stood in ' + d.toLocaleDateString(undefined, {
