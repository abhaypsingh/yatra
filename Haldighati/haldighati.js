/* ============================================================
   HALDIGHATI — the turmeric pass
   A record of the narrow passes where you fought your decisive battles
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-haldighati-passes';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'marched through ' + d.toLocaleDateString(undefined, {
