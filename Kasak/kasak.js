/* ============================================================
   KASAK — the lingering ache
   A record of the aches that lingered long after the wound had healed
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-kasak-aches';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'carried ' + d.toLocaleDateString(undefined, {
