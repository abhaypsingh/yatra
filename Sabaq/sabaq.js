/* ============================================================
   SABAQ — the lesson
   A record of the lessons learned the hard way that the easy way could never teach
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-sabaq-lessons';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'learned ' + d.toLocaleDateString(undefined, {
