/* ============================================================
   VAIDYA — the healer
   A record of the healers who diagnosed what medicine could not reach
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-vaidya-healers';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'was healed by ' + d.toLocaleDateString(undefined, {
