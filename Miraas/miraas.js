/* ============================================================
   MIRAAS — the inheritance
   A record of the inheritances that shaped your path
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-miraas-inheritances';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'inherited ' + d.toLocaleDateString(undefined, {
