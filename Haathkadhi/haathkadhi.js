/* ============================================================
   HAATHKADHI — the shackle
   A record of the bindings you wore and the freedom found in accepting them
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-haathkadhi-shackles';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'wore ' + d.toLocaleDateString(undefined, {
