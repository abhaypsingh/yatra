/* ============================================================
   GIRDAAB — the whirlpool
   A record of the vortexes that pulled you under
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-girdaab-vortexes';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'escaped ' + d.toLocaleDateString(undefined, {
