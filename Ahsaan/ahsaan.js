/* ============================================================
   AHSAAN — the favour
   A record of the favours received that could never be fully repaid
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-ahsaan-favours';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'owed ' + d.toLocaleDateString(undefined, {
