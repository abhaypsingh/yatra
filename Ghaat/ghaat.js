/* ============================================================
   GHAAT — the river steps
   A record of the descents to the water where you washed away what needed releasing
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-ghaat-steps';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'walked down ' + d.toLocaleDateString(undefined, {
