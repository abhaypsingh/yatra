/* ============================================================
   TAMAASHA — the spectacle
   A record of the spectacles that dazzled or dismayed
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-tamaasha-spectacles';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'watched ' + d.toLocaleDateString(undefined, {
