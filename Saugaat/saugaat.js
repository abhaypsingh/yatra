/* ============================================================
   SAUGAAT — the gift
   A record of the gifts that carried meaning far beyond their material worth
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-saugaat-gifts';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'received ' + d.toLocaleDateString(undefined, {
