/* ============================================================
   RAKH — the ash
   A record of what remained after the fire had done its work
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-rakh-ashes';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'sifted through ' + d.toLocaleDateString(undefined, {
