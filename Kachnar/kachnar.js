/* ============================================================
   KACHNAR — the orchid tree
   A record of the unexpected blooms that appeared in the harshest seasons
   ============================================================ */
...
(function () {
  ...
  /* ==================== STATE ==================== */
  var STORE_KEY = 'yatra-kachnar-blooms';
  var items = [];
  ...
  function showDetail(p) {
    ...
    detailDate.textContent = 'watched bloom ' + d.toLocaleDateString(undefined, {
